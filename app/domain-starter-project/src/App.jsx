...
// Constants
const TWITTER_HANDLE = "_tokioensspace";
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;

// Add the domain you will be minting
const tld = ".tokio";
const CONTRACT_ADDRESS = "0x67BF653cF3D6B2F1613b68A4b740C713BccCAB42";
		...
		<div className="App">
			<div className="container">
				<div className="header-container">
					<header>
						<div className="left">
							<p className="title">&#128293; Tokio Name Service</p>
							<p className="subtitle">
								Record your Tokio name and your breathing style on the
								blockchain forever!
							</p>
						</div>
